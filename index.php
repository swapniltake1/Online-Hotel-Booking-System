       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              Address : Newasa, Ahmednagar Maharashtra <br>
              Mail : swapniltake1@outlook.com <br>
              Phone : 8600789879 <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                <a href="https://github.com/swapniltake1"><img src="images/us/Swapnil.jpg" class="pro_pic" > Swapnil Take </a>
